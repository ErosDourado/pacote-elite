...
const BLANK = { name: '', category: 'Cílios', price: '', stockQty: '', description: '', imageUrl: '' }
        ...
        <div className="flex flex-col gap-3">
          {filtered.map(prod => (
            <div key={prod.id} className="ios-card p-4 flex items-center gap-3">
              {prod.imageUrl ? (
                <img src={prod.imageUrl} alt={prod.name} className="w-14 h-14 rounded-2xl object-cover flex-shrink-0" onError={e => e.target.style.display='none'} />
              ) : (
